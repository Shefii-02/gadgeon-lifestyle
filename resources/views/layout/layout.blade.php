...
<head>
    ...
    <title>Gadgeon:: {{ $title ?? 'HOME' }}</title>
    <meta name="description" content="GadgeonLLP , ">
    <meta property="og:title" content="Gadgeon:: {{ $title ?? 'HOME' }}" />
    <meta property="og:description" content="GadgeonLLP , " />
    ...
    <link rel="icon" href="https://www.gadgeon.ae/wp-content/uploads/2023/09/cropped-fav-32x32.png"
        sizes="32x32" />
    <link rel="icon" href="https://www.gadgeon.ae/wp-content/uploads/2023/09/cropped-fav-192x192.png"
        sizes="192x192" />
    ...
    <link href="{{ asset('assets/css/style.css?v=1.4') }}" rel="stylesheet">
    ...
    <header class="header">
        ...
        <div class="container">
            <div class="col-lg-12 main-header">
                <div class="row">
                    <div class="col-lg-3 col-sm-8 col-6  d-flex align-items-center">
                        <a href="/" title="gadgeon" class="">
                            <img src="{{ asset('assets/images/gadgeon-logo.svg') }}" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="col-lg-9 col-sm-2 col-2  d-none d-lg-block align-self-center">
                        ...
                        <ul class="main-menu text-end gap-2">
                            <li class="menu-item ">
                                <a href="{{ asset('assets/Gadgeon_Industrail_Solutions.pdf') }}"
                                    download="Gadgeon Industrail Solutions.pdf" class="btn btn-theme2 rounded-5"><i
                                        class="bi bi-download me-2"></i>
                                    E-BROCHURE</a>
                            </li>
                            <li class="menu-item ">
                                <a href="{{ url('contact-us') }}" class="btn btn-theme rounded-5">Contact US</a>
                            </li>
                            <li class="menu-item ">
                ...
                <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                    <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                        <div class="footer-logo-wrapper text-center text-sm-start">
                            <a href="#!">
                                <img src="{{ asset('assets/images/gadgeon-logo.svg') }}" alt="Logo"
                                    width="175" height="57">
                            </a>
                        </div>
                    </div>
        ...
        <div class="wa__popup_content wa__popup_content_left">
            ...
            <div class="wa__popup_content_list">
                <div class="wa__popup_content_item ">
                    ...
                    <a target="_blank"
                        href="https://wa.me/+917736462646?text=i%20need%20more%20details%20your%20product%20and%20services"

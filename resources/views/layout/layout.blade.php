                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-sm-2 col-2  d-none d-lg-block align-self-center">
                        ...
                        <ul class="main-menu text-end gap-2">
                            <li class="menu-item ">
                                <a href="{{asset('assets/Gadgeon_Industrail_Solutions.pdf')}}"  download="Gadgeon Industrail Solutions.pdf" class="btn btn-theme2 rounded-5"><i class="bi bi-download me-2"></i>
                                    E-BROCHURE</a>
                            </li>
                            <li class="menu-item ">
                    ...
                    <div class="offcanvas offcanvas-end px-5" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-body mt-2">
                            <ul class="list-unstyled text-left">
                                ...
                                <li class=" mb-4 {{ $title == 'Products' ? 'active' : '' }}">
                            ...
                            <h6 class="mt-5"><a href="mailto:smartindustry@gadgeon.com"  class="text-dark">smartindustry@gadgeon.com</a> </h6>
                ...
                <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                    <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                        <div class="footer-logo-wrapper text-center text-sm-start">
                            <a href="#!">
                                <img src="{{ asset('assets/images/gadgeon-logo.svg') }}" alt="Logo" width="175" height="57">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-xl-6 order-2 order-xl-1">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="{{url('products')}}">Products</a>
                            </li>
                        </ul>
                    </div>
